    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid">
            <div class="col-md-12 col-lg-12 justify-content-center">
                <?php
                    $departamente = new Departament();
                    $departament = $departamente->getData();
                ?>
                <h4 style="text-align: center">Departamente</h4>
                <div class="pontariTable">
                    <table class="table">
                        ...
                        foreach($departament as $dep)
                        {
                            ...
                            echo '<th>'.$dep->id.'</th>';
                            echo '<th>'.$dep->nume.'</th>';
                            echo '<th>'.$dep->angajati.'</th>';
                            echo '<th>'.$dep->manager.'</th>';
                            echo "<th>
                                                <a href='editare_departament?user={$usera}&id={$dep->id}' class='btn btn-warning'>Editeaza</a></th>
                                                <th><a href='sterge_departament?user={$usera}&id={$dep->id}' class='btn btn-danger' style='margin-left: 1rem;'>Sterge departament</a>
                                          </th>";
