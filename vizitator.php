...
if(Input::exists()) {
    if(Token::check(Input::get('token'))) {
        ...
        if($validate->passed()) {
            ...
            else if($selectedval == "vizitator")
            {
                Redirect::to('vizitator.php');
            }
            else {
...
<div class="container">
    <div class="row">
        <div class="col-md-12 col-lg-12 d-flex justify-content-center">
            <form class="text-center border border-light p-5" action="" method="post">
                <div style="display: flex;margin-bottom: 2rem;flex-direction: column;">
                    <p class="h4 mb-4" style="padding-right: 2rem">Rol</p>
                    <select name="grade" class="browser-default custom-select rol">
                        <option selected>Selecteaza un rol</option>
                        <option value="angajat">Angajat</option>
                        <option value="vizitator">Vizitator</option>
                    </select>
                </div>
                <div id="vizitator_check" style="display: none;">
                    <p class="h4 mb-4" style="padding-right: 2rem">Vizita pentru</p>
                    <select class="browser-default custom-select">
                        <option selected>Selecteaza de ce ai venit</option>
    ...
    <div class="row angajatRow" style="display: none">
        <div class="col-md-12 col-lg-12 d-flex justify-content-center">
            <!-- Default form login -->
            <form class="text-center border border-light p-5" action="" method="post">
