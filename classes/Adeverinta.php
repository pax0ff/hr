...
class Adeverinta
{
    ...
    public function createAdeverintaVenit($fields = array()) {
        if(!$this->_db->insert('adeverinte_venit', $fields)) {
            throw new Exception('Sorry, there was a problem to create new employer holiday');
        }
    }
    public function createAdeverintaSalariat($fields = array()) {
        if(!$this->_db->insert('adeverinte_salariat', $fields)) {
            throw new Exception('Sorry, there was a problem to create new employer holiday');
        }
    }
    public function createAdeverintaVenitCNAS($fields = array()) {
