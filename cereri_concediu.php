                ...
                <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="profile?user=<?php echo $usera; ?>">Profile</a>
            ...
            <div class="calendar">
                <div class="grid">
                    ...
                    foreach($concedii as $c)
                    {
                        ...
                        $dataInceput = intval(date("d-n-Y",$inceput));
                        $dataSfarsit = intval(date("d-n-Y",$sfarsit));

                        for($i=1;$i<=$daysOfCurrentMonth;$i++)
                        {
                            if($i == $dataInceput && $c->aprobat == 1) {
                                for($j=$dataInceput;$j<=$dataSfarsit;$j++){
                                    echo '<span id="day" style="background:white;text-align: center;font-size:10px">'.$i++.' '.$c->nume.'</span>';
                                }
                            }
                            echo '<span id="day" style="font-size: 10px;">'.$i.'</span>';
                        }
                    }
